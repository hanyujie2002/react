...
* [如何将 UI 变更视为状态变更 | How to think about UI changes as state changes](/learn/reacting-to-input-with-state)
* [如何组织好状态 | How to structure state well](/learn/choosing-the-state-structure)
* [如何使用“状态提升”在组件之间共享状态 | How to "lift state up" to share it between components](/learn/sharing-state-between-components)
* [如何控制状态的保留或重置 | How to control whether the state gets preserved or reset](/learn/preserving-and-resetting-state)
* [如何在函数中整合复杂的状态逻辑 | How to consolidate complex state logic in a function](/learn/extracting-state-logic-into-a-reducer)
* [如何避免数据通过 prop 逐级透传 | How to pass information without "prop drilling"](/learn/passing-data-deeply-with-context)
* [如何随着应用的增长去扩展状态管理 | How to scale state management as your app grows](/learn/scaling-up-with-reducer-and-context)

</YouWillLearn>

## 用 State 响应输入 | Reacting to input with state {/*reacting-to-input-with-state*/}
...
## 选择 State 结构 | Choosing the state structure {/*choosing-the-state-structure*/}
...
## 在组件间共享状态 | Sharing state between components {/*sharing-state-between-components*/}
...
## 对 state 进行保留和重置 | Preserving and resetting state {/*preserving-and-resetting-state*/}
...
## 迁移状态逻辑至 Reducer 中 | Extracting state logic into a reducer {/*extracting-state-logic-into-a-reducer*/}
...
## 使用 Context 深层传递参数 | Passing data deeply with context {/*passing-data-deeply-with-context*/}
...
## 使用 Reducer 和 Context 拓展你的应用 | Scaling up with reducer and context {/*scaling-up-with-reducer-and-context*/}
